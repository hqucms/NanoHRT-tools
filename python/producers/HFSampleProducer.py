...
class HFQCDSFTreeProducer(Module):
    ...
    def _correctJetAndMET(self, event):
        ...
        event.ak15Subjets = Collection(event, "SubJet")  # do not sort after updating!!
        ...
        event._allAK15jets = Collection(event, "FatJet")
    ...
    def _prepareEvent(self, event):
        ...
        if (len(event.ak15jets)<2):
            return False
        if (event.ak15jets[1].pt < 200):
            return False
        if ( (event.ak15jets[1].msoftdrop < 50) or (event.ak15jets[1].msoftdrop > 200)):
            return False
        ...
        drsj12_ = 0.5*(deltaR(event.ak15jets[1].subjets[0],event.ak15jets[1].subjets[1]))
        ...
        for isv in event.sv:
            if deltaR(isv,event.ak15jets[1].subjets[0]) < drcut_:
                nsvsj1_ += 1
            elif deltaR(isv,event.ak15jets[1].subjets[1]) < drcut_:
                nsvsj2_ += 1
    ...
    def _fillEventInfo(self, event):
        ...
        ## fj variables
        self.out.fillBranch("n_fatjet", len(event.ak15jets))

        if len(event.ak15jets)>0:
            self.out.fillBranch("fj_1_nbhadrons", event.ak15jets[0].nBHadrons)
            self.out.fillBranch("fj_1_nchadrons", event.ak15jets[0].nCHadrons)
            self.out.fillBranch("fj_1_pt", event.ak15jets[0].pt)
            self.out.fillBranch("fj_1_eta", event.ak15jets[0].eta)
            self.out.fillBranch("fj_1_phi", event.ak15jets[0].phi)
	    self.out.fillBranch("fj_1_sdmass", event.ak15jets[0].msoftdrop)
            self.out.fillBranch("fj_1_sjmass", get_sdmass(event.ak15jets[0].subjets))
	    self.out.fillBranch("fj_1_score_cc", event.ak15jets[0].deepTagMD_ccvsLight)
	    self.out.fillBranch("fj_1_score_bb", event.ak15jets[0].deepTagMD_bbvsLight)
    	    self.out.fillBranch("fj_1_tau21", (event.ak15jets[0].tau2/event.ak15jets[0].tau1) if event.ak15jets[0].tau1>0 else -1.)
            self.out.fillBranch("fj_1_btagcsvv2", event.ak15jets[0].btagCSVV2)
            #self.out.fillBranch("fj_1_btagjp", event.ak15jets[0].btagJP)

            ## go to sj
	    self.out.fillBranch("fj_1_sj1_pt", event.ak15jets[0].subjets[0].pt)
	    self.out.fillBranch("fj_1_sj1_eta", event.ak15jets[0].subjets[0].eta)
	    self.out.fillBranch("fj_1_sj1_phi", event.ak15jets[0].subjets[0].phi)
            self.out.fillBranch("fj_1_sj1_nbhadrons", event.ak15jets[0].subjets[0].nBHadrons)
	    self.out.fillBranch("fj_1_sj1_nchadrons", event.ak15jets[0].subjets[0].nCHadrons)
	    self.out.fillBranch("fj_1_sj1_btagcsvv2", event.ak15jets[0].subjets[0].btagCSVV2)
            #Self.out.fillBranch("fj_1_sj1_btagjp", event.ak15jets[0].subjets[0].btagJP)

	    self.out.fillBranch("fj_1_sj2_pt", event.ak15jets[0].subjets[1].pt)
	    self.out.fillBranch("fj_1_sj2_eta", event.ak15jets[0].subjets[1].eta)
	    self.out.fillBranch("fj_1_sj2_phi", event.ak15jets[0].subjets[1].phi)
            self.out.fillBranch("fj_1_sj2_nbhadrons", event.ak15jets[0].subjets[1].nBHadrons)
	    self.out.fillBranch("fj_1_sj2_nchadrons", event.ak15jets[0].subjets[1].nCHadrons)
            self.out.fillBranch("fj_1_sj2_btagcsvv2", event.ak15jets[0].subjets[1].btagCSVV2)
            #self.out.fillBranch("fj_1_sj2_btagjp", event.ak15jets[0].subjets[1].btagJP)

            ## sv vars related to each sj [for the leading in pt fatjet]
            sj_drsj12_ = 0.5*(deltaR(event.ak15jets[0].subjets[0],event.ak15jets[0].subjets[1]))
            ...
            for isv in event.sv:
                ...
                if deltaR(isv,event.ak15jets[0].subjets[0]) < sj_drcut_:
                    sj1_nsv_ += 1
                    if sj1_nsv_ == 1:
                ...
                elif deltaR(isv,event.ak15jets[0].subjets[1]) < sj_drcut_:
                    sj2_nsv_ += 1
                    if sj2_nsv_ == 1:
        ...
        if len(event.ak15jets)>1:
            
            self.out.fillBranch("fj_2_nbhadrons", event.ak15jets[1].nBHadrons)
            self.out.fillBranch("fj_2_nchadrons", event.ak15jets[1].nCHadrons)
            self.out.fillBranch("fj_2_pt", event.ak15jets[1].pt)
            self.out.fillBranch("fj_2_eta", event.ak15jets[1].eta)
            self.out.fillBranch("fj_2_phi", event.ak15jets[1].phi)
	    self.out.fillBranch("fj_2_sdmass", event.ak15jets[1].msoftdrop)
            self.out.fillBranch("fj_2_sjmass", get_sdmass(event.ak15jets[1].subjets))
            self.out.fillBranch("fj_2_score_cc", event.ak15jets[1].deepTagMD_ccvsLight)
            self.out.fillBranch("fj_2_score_bb", event.ak15jets[1].deepTagMD_bbvsLight)
    	    self.out.fillBranch("fj_2_tau21", (event.ak15jets[1].tau2/event.ak15jets[1].tau1) if event.ak15jets[1].tau1>0 else -1.)
            self.out.fillBranch("fj_2_btagcsvv2", event.ak15jets[1].btagCSVV2)
            #self.out.fillBranch("fj_2_btagjp", event.ak15jets[1].btagJP)

            ## go to sj
	    self.out.fillBranch("fj_2_sj1_pt", event.ak15jets[1].subjets[0].pt)
	    self.out.fillBranch("fj_2_sj1_eta", event.ak15jets[1].subjets[0].eta)
	    self.out.fillBranch("fj_2_sj1_phi", event.ak15jets[1].subjets[0].phi)
            self.out.fillBranch("fj_2_sj1_nbhadrons", event.ak15jets[1].subjets[0].nBHadrons)
	    self.out.fillBranch("fj_2_sj1_nchadrons", event.ak15jets[1].subjets[0].nCHadrons)
	    self.out.fillBranch("fj_2_sj1_btagcsvv2", event.ak15jets[1].subjets[0].btagCSVV2)
            #self.out.fillBranch("fj_2_sj1_btagjp", event.ak15jets[1].subjets[0].btagJP)

	    self.out.fillBranch("fj_2_sj2_pt", event.ak15jets[1].subjets[1].pt)
	    self.out.fillBranch("fj_2_sj2_eta", event.ak15jets[1].subjets[1].eta)
	    self.out.fillBranch("fj_2_sj2_phi", event.ak15jets[1].subjets[1].phi)
            self.out.fillBranch("fj_2_sj2_nbhadrons", event.ak15jets[1].subjets[1].nBHadrons)
	    self.out.fillBranch("fj_2_sj2_nchadrons", event.ak15jets[1].subjets[1].nCHadrons)
            self.out.fillBranch("fj_2_sj2_btagcsvv2", event.ak15jets[1].subjets[1].btagCSVV2)
            #self.out.fillBranch("fj_2_sj2_btagjp", event.ak15jets[1].subjets[1].btagJP)

            ## sv vars related to each sj
            sj_drsj12_ = 0.5*(deltaR(event.ak15jets[1].subjets[0],event.ak15jets[1].subjets[1]))
            sj_drcut_  = min(0.4,sj_drsj12_);
            sj1_nsv_ , sj2_nsv_ = 0 , 0
            sj1_masscor_ , sj1_dxysig_ = 0. , 0.
            sj2_masscor_ , sj2_dxysig_ = 0. , 0.
            ...
            for isv in event.sv:
                ...
                if deltaR(isv,event.ak15jets[1].subjets[0]) < sj_drcut_:
                    sj1_nsv_ += 1
                    if sj1_nsv_ == 1:
                        ...
                        sj1_masscor_ = correctedsvmass(isv)
                        sj1_dxysig_  = isv.dxySig
                elif deltaR(isv,event.ak15jets[1].subjets[1]) < sj_drcut_:
                    sj2_nsv_ += 1
                    if sj2_nsv_ == 1:
