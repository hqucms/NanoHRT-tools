...
class HRTBaseProducer(Module, object):
    ...
    def beginFile(self, inputFile, outputFile, inputTree, wrappedOutputTree):
        ...
        if self.hasParticleNet:
            ...
            self.out.branch("ak8_1_ParsticleNetMD_Xbb", "F")
...
#             event.Flag_BadChargedCandidateFilter
    ...
    def fillFatJetInfo(self, event, fillGenMatching=False):
        ...
        fillBranchAK8(prefix + "DeepAK8_ZHbbvsQCD", ((fj.deepTag_probZbb + fj.deepTag_probHbb))/(fj.deepTag_probZbb + fj.deepTag_probHbb + fj.deepTag_probQCDbb + fj.deepTag_probQCDb + fj.deepTag_probQCDcc + fj.deepTag_probQCDc + fj.deepTag_probQCDothers) )
