...
#             event.Flag_BadChargedCandidateFilter
    ...
    def fillFatJetInfo(self, event, fillGenMatching=False):
        ...
        #fillBranchAK8("ak8_1_DeepAK8_ZHbbvsQCD", ((ak8.deepTag_probZbb + ak8.deepTag_probHbb))/(ak8.deepTag_probZbb + ak8.deepTag_probHbb + ak8.deepTag_probQCDbb + ak8.deepTag_probQCDb + ak8.deepTag_probQCDcc + ak8.deepTag_probQCDc + ak8.deepTag_probQCDothers) )
